...
function generateSitemapPlugin(): Plugin {
  ...
  const staticUrls = [
    ...
    { loc: "/contractor-job-management-software", changefreq: "monthly", priority: "0.8" },
    { loc: "/contractor-invoicing-software", changefreq: "monthly", priority: "0.8" },
    { loc: "/customer-portal-for-contractors", changefreq: "monthly", priority: "0.8" },
