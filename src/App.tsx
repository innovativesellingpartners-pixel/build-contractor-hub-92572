...
import CityTradePage from "@/pages/CityTradePage";
      ...
      <AuthProvider>
        <TooltipProvider>
          ...
          <Route path="/portal/:token" element={<CustomerPortal />} />
            ...
            <Route path="/crm-for-:tradeSlug-in-:citySlug" element={<CityTradePage />} />
            <Route path="/crm-for-:slug" element={<CrmForTrade />} />
