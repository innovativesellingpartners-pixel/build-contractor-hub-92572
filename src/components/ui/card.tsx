...
const Card = React.forwardRef<HTMLDivElement, CardProps>(({ className, variant = 'default', ...props }, ref) => {
  const variantClasses = {
    ...
    orange: 'bg-orange-50 border-orange-200/50 dark:bg-orange-950/30 dark:border-orange-800/40',
    gradient: 'bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 border-purple-200/50 dark:from-blue-950/20 dark:via-purple-950/20 dark:to-pink-950/20',
  };
