...
export function DetailHeader({ title, subtitle, onBack, onDashboard, rightContent }: DetailHeaderProps) {
  return (
    <div className="sticky top-0 z-50 bg-foreground text-background px-3 py-2 flex flex-col gap-2 pt-[calc(4.5rem+env(safe-area-inset-top))] sm:pt-[max(0.75rem,env(safe-area-inset-top))]">
