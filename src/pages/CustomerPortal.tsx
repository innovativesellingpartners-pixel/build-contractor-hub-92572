  ...
  const { data: portalData, isLoading, error } = useQuery({
    ...
    queryFn: async () => {
      ...
      const { data: profile } = await supabase
        .from('profiles')
        .select('company_name, contact_name, phone, business_email, logo_url, brand_primary_color, finix_merchant_id, finix_environment, zelle_email, zelle_phone, ach_instructions, accepted_payment_methods')
