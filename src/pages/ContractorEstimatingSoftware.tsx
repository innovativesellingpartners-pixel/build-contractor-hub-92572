  ...
  return (
    <>
      <div className="min-h-screen bg-background text-foreground">
        ...
        <section className="relative overflow-hidden bg-ct1-black py-24 sm:py-32">
          ...
          <div className="relative mx-auto max-w-5xl px-6 text-center">
            <h1 className="text-4xl font-extrabold tracking-tight text-ct1-white sm:text-5xl lg:text-6xl">
              Contractor Estimating Software That Wins More Jobs
            </h1>
        ...
        {/* Section 1 - Slow Estimates Lose Jobs */}
        <section className="py-20 sm:py-28">
          <div className="mx-auto max-w-5xl px-6">
            <div className="mx-auto max-w-3xl text-center">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
                Slow Estimates Cost You Real Money
              </h2>
        ...
        <section className="bg-secondary/40 py-20 sm:py-28">
          <div className="mx-auto max-w-5xl px-6">
            <div className="grid items-center gap-12 lg:grid-cols-2">
              <div>
                <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
                  Professional Estimates in Minutes, Not Hours
                </h2>
                <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
        ...
        {/* Section 3 - Digital Delivery and Approvals */}
        <section className="py-20 sm:py-28">
          <div className="mx-auto max-w-5xl px-6 text-center">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
              Send, Track, and Get Approved Digitally
            </h2>
        ...
        <section className="bg-secondary/40 py-20 sm:py-28">
          <div className="mx-auto max-w-5xl px-6">
            <div className="mx-auto max-w-3xl text-center">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
                Know Exactly Where Every Quote Stands
              </h2>
              <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
            ...
            <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                <div key={status} className="flex items-center gap-4 rounded-xl border border-border bg-card px-6 py-4 shadow-sm">
          ...
          <div className="mx-auto max-w-5xl px-6">
            <div className="grid items-center gap-12 lg:grid-cols-2">
              <div className="order-2 lg:order-1">
                <div className="space-y-4">
                  {[
                    ...
                    <div key={step} className="flex items-start gap-4 rounded-xl border border-border bg-card p-5 shadow-sm">
              ...
              <div className="order-1 lg:order-2">
                <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
                  Approved Estimates Become Scheduled Jobs Instantly
                </h2>
                <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
