  ...
  return (
    <div className="relative w-full aspect-[4/3] max-w-2xl mx-auto">
      <svg viewBox="0 0 900 600" className="w-full h-full">
        ...
        <path
          d="M50,150 L150,100 L300,80 L450,70 L600,80 L750,100 L850,150 L870,250 L860,350 L820,450 L750,520 L600,550 L450,560 L300,550 L150,520 L80,450 L50,350 L40,250 Z"
          fill="hsl(var(--muted))"
