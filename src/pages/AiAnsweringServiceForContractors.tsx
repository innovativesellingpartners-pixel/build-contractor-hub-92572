  ...
  return (
    <>
      <div className="min-h-screen bg-background text-foreground">
        ...
        {/* Section 1 - Missed Calls Cost Jobs */}
        ...
        {/* Section 2 - How AI Answers Calls */}
        <section className="bg-secondary/40 py-20 sm:py-28">
          <div className="mx-auto max-w-5xl px-6">
            <div className="grid items-center gap-12 lg:grid-cols-2">
              <div>
                <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
                  AI Picks Up, Greets, and Captures Every Detail
                </h2>
                <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
                  ...
                  and project details, then sends you a complete summary instantly. The caller gets a great first
                  impression and you get a qualified lead.
                </p>
        ...
        {/* Section 3 - After-Hours Capture */}
        <section className="py-20 sm:py-28">
          <div className="mx-auto max-w-5xl px-6 text-center">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
              Capture Leads After Hours, Weekends, and Holidays
            </h2>
            <p className="mt-6 mx-auto max-w-2xl text-lg text-muted-foreground">
              Homeowners search for contractors at night and on weekends. If your phone goes to voicemail at 8 PM, that
              lead goes to a competitor who answers. The myCT1 AI agent works 24/7, 365 days a year. Every call gets
              answered, every lead gets captured, and you start every morning with new opportunities waiting in your
              dashboard.
            </p>
        ...
        {/* Section 4 - Automated Appointment Booking */}
        <section className="bg-secondary/40 py-20 sm:py-28">
          <div className="mx-auto max-w-5xl px-6">
            <div className="mx-auto max-w-3xl text-center">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
                Book Appointments Without Lifting a Finger
              </h2>
              <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
                ...
                calendar, and a confirmation message is sent. You go from missed call to booked appointment without ever
                touching your phone.
              </p>
            </div>
            <div className="mt-14 grid gap-6 sm:grid-cols-3">
              {[
                ...
                <div key={step} className="rounded-xl border border-border bg-card p-6 text-center shadow-sm">
        ...
        <section className="py-20 sm:py-28">
          <div className="mx-auto max-w-5xl px-6">
            <div className="grid items-center gap-12 lg:grid-cols-2">
              <div>
                <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
                  Qualified Leads Before You Call Back
                </h2>
                <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
                  ...
                  up, you already know if the lead is a good fit. Spend your time on prospects who are ready to move
                  forward.
                </p>
                <ul className="mt-8 space-y-4">
                  {[
                ...
                <div className="mt-8">
                  <Button asChild variant="link" className="px-0 text-primary">
                    <Link to="/products/voice-ai">Learn more about PocketBot Voice AI <ArrowRight className="ml-1 h-4 w-4" /></Link>
                  </Button>
                </div>
              </div>
              <div className="rounded-2xl border border-border bg-card p-8 shadow-lg">
        ...
        <section className="bg-ct1-black py-20 sm:py-28">
          <div className="mx-auto max-w-3xl px-6 text-center">
            <h2 className="text-3xl font-bold tracking-tight text-ct1-white sm:text-4xl">
              Stop Missing Calls. Start Closing More Jobs.
            </h2>
